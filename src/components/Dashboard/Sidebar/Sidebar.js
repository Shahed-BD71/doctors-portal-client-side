...
import { faCalendar, faCog, faFilter, faGripHorizontal, faSignOutAlt, faUser, faUserPlus } from "@fortawesome/free-solid-svg-icons";
...
const Sidebar = () => {
  ...
  useEffect(() => {
    fetch(`https://doctorsportal.herokuapp.com/isDoctor`, {
      method: "POST",
